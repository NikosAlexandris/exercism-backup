...
def get_value_of_bills(denomination, number_of_bills):
    ...
    """
    return denomination // 1 * number_of_bills
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    value_after_exchange = exchange_money(budget=budget, exchange_rate=exchange_rate)
    leftover_of_bills = get_leftover_of_bills(amount=value_after_exchange, denomination=denomination)
    return (value_after_exchange - leftover_of_bills)